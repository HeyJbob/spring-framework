 ...
 * <li>The ability to publish events to registered listeners. 向注册的监听器发布事件的能力。
 * Inherited from the {@link ApplicationEventPublisher} interface.
 * <li>The ability to resolve messages, supporting internationalization. 解析消息的能力，支持国际化。
